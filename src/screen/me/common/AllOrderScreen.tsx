...
export default class AllOrderScreen extends React.Component<any,any> {
    constructor(props) {
        super(props);
        this.state = {
            list:[{id:'1'},{id:'2'},{id:'3'}],
                ...
                <View style={styles.ccontentBox}>
                    <View style={styles.tabBox}>
                        <View style={styles.tabBoxItem}>
                            <Text onPress={()=>{
                                this._onTabClick('1')
                            }} style={[styles.tabBoxItemText,{color:this.state.tabIndex+''==='1'?'#E7232E':'#666'}]}>全部</Text>
                            {this.state.tabIndex+''==='1'?<View style={styles.tabBoxItemHengXian}/>:null}
                        </View>
                        <View style={styles.tabBoxItem}>
                            <Text onPress={()=>{
                                this._onTabClick('2')
                            }}  style={[styles.tabBoxItemText,{color:this.state.tabIndex+''==='2'?'#E7232E':'#666'}]}>待付款</Text>
                            {this.state.tabIndex+''==='2'?<View style={styles.tabBoxItemHengXian}/>:null}
                        </View>
                        <View style={styles.tabBoxItem}>
                            <Text  onPress={()=>{
                                this._onTabClick('3')
                            }} style={[styles.tabBoxItemText,{color:this.state.tabIndex+''==='3'?'#E7232E':'#666'}]}>待发货</Text>
                            {this.state.tabIndex+''==='3'?<View style={styles.tabBoxItemHengXian}/>:null}
                        </View>
                        <View style={styles.tabBoxItem}>
                            <Text  onPress={()=>{
                                this._onTabClick('4')
                            }} style={[styles.tabBoxItemText,{color:this.state.tabIndex+''==='4'?'#E7232E':'#666'}]}>已发货</Text>
                            {this.state.tabIndex+''==='4'?<View style={styles.tabBoxItemHengXian}/>:null}
                        </View>
                        <View style={styles.tabBoxItem}>
                            <Text  onPress={()=>{
                                this._onTabClick('5')
                            }} style={[styles.tabBoxItemText,{color:this.state.tabIndex+''==='5'?'#E7232E':'#666'}]}>已完成</Text>
                            {this.state.tabIndex+''==='5'?<View style={styles.tabBoxItemHengXian}/>:null}
                        </View>
                    </View>
                    <View style={{flex:1}}>
                        <FlatList
                                ...
                                <TouchableOpacity>
                                    <View style={styles.listItem}>
                                        <View style={styles.listItemHeader}>
                                            <View>
                                                <Text style={styles.listItemHeaderLeftText}>2020年8月11日02:00:37</Text>
                                            </View>
                                            <View style={styles.listItemHeaderRight}>
                                                <Text style={styles.listItemHeaderRightText}>待付款</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={styles.listItemFooterBtn}>
                                            <Text style={styles.listItemFooterBtnText}>取消订单</Text><Text style={styles.listItemFooterBtnText}>付款</Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                            )}
